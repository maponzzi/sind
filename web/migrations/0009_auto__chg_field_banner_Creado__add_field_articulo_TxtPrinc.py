...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Banner.Creado'
        db.alter_column(u'web_banner', 'Creado', self.gf('django.db.models.fields.DateTimeField')())
        # Adding field 'Articulo.TxtPrinc'
        db.add_column(u'web_articulo', 'TxtPrinc',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Banner.Creado'
        db.alter_column(u'web_banner', 'Creado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Deleting field 'Articulo.TxtPrinc'
        db.delete_column(u'web_articulo', 'TxtPrinc')
    ...
    models = {
        u'web.articulo': {
            ...
            'TxtPrinc': ('django.db.models.fields.CharField', [], {'max_length': '400', 'blank': 'True'}),
