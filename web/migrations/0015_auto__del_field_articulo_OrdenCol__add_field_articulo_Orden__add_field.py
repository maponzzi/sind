...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Articulo.OrdenCol'
        db.delete_column(u'web_articulo', 'OrdenCol')

        # Adding field 'Articulo.Orden'
        db.add_column(u'web_articulo', 'Orden',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Articulo.Stt'
        db.add_column(u'web_articulo', 'Stt',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Articulo.OrdenCol'
        db.add_column(u'web_articulo', 'OrdenCol',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Articulo.Orden'
        db.delete_column(u'web_articulo', 'Orden')

        # Deleting field 'Articulo.Stt'
        db.delete_column(u'web_articulo', 'Stt')
