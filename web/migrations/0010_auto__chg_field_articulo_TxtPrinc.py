...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Articulo.TxtPrinc'
        db.alter_column(u'web_articulo', 'TxtPrinc', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Articulo.TxtPrinc'
        db.alter_column(u'web_articulo', 'TxtPrinc', self.gf('django.db.models.fields.CharField')(max_length=400))
